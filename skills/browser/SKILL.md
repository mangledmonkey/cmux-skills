...
|----------|-------------|
| `${CLAUDE_PLUGIN_ROOT}/skills/browser/templates/form-automation.sh` | Snapshot/ref form fill loop |
| `${CLAUDE_PLUGIN_ROOT}/skills/browser/templates/authenticated-session.sh` | Login once, save/load state |
| `${CLAUDE_PLUGIN_ROOT}/skills/browser/templates/capture-workflow.sh` | Navigate and capture snapshots/screenshots |
