...
```bash
${CLAUDE_PLUGIN_ROOT}/skills/cmux-debug-windows/scripts/debug_windows_snapshot.sh --copy
```
...
Examples:
```bash
${CLAUDE_PLUGIN_ROOT}/skills/cmux-debug-windows/scripts/debug_windows_snapshot.sh
${CLAUDE_PLUGIN_ROOT}/skills/cmux-debug-windows/scripts/debug_windows_snapshot.sh --copy
${CLAUDE_PLUGIN_ROOT}/skills/cmux-debug-windows/scripts/debug_windows_snapshot.sh --domain <bundle-id> --copy
```
